      ...
      <Page size="A4" style={styles.page}>
            ...
            <View style={styles.clientBlock}>
              ...
              {data?.codigoCliente ? (
                <View style={styles.clientRow}>
                  <Text style={styles.clientRowLabel}>Código:</Text>
                  <Text style={styles.clientRowValue}>
                    {data.codigoCliente}
                  </Text>
                </View>
              ) : null}
              ...
              <View style={styles.clientRow}>
                <Text style={styles.clientRowLabel}>Email:</Text>
                <Text style={styles.clientRowValue}>
                  {data?.clienteEmail || "—"}
                </Text>
              </View>
              {data?.clienteTelefono ? (
                <View style={styles.clientRow}>
                  <Text style={styles.clientRowLabel}>Tel:</Text>
                  <Text style={styles.clientRowValue}>
                    {data.clienteTelefono}
                  </Text>
                </View>
        ...
        <View style={styles.metaStrip}>
          ...
          <View style={styles.metaItem}>
            ...
            <Text style={styles.metaValue}>
              {lb(data?.items?.reduce((s, i) => s + (Number(i.peso) || 0), 0))}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          {data?.items?.map((it, idx) => (
            <View
              key={idx}
              style={[styles.tbodyRow, idx % 2 === 1 ? styles.tbodyRowAlt : {}]}
            >
              ...
              <Text style={[styles.colPrecio, styles.td]}>
                {money(it.precioLb)}
              </Text>
        ...
        <Text style={styles.disclaimer}>
          Para reclamos o devoluciones presente este documento. Los precios
          incluyen impuestos aplicables.
        </Text>
      </Page>
    </Document>
  );
